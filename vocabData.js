...
export const communicationVerbs = [
...
export const propertiesAdjectives = [
    ...
    { front: "つめたい",reading: "",back: "Cold (things; personality)"}, { front: "新しい", reading: "あたらしい", back: "New"},
...
export const popularPlaces = [
    { front: "サンフランシスコ",reading: "",back: "San Francisco"}
]
